...
func (l *GetStockByNameLogic) GetStockByName(req types.ReqStockByName) (*types.RespStockDetail, error) {
	rsp, err := l.svcCtx.Stock.GetStockByName(l.ctx, &stock.NameRequest{
