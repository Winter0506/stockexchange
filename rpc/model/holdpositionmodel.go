...
func (m *defaultHoldpositionModel) Insert(data *Holdposition) (sql.Result, error) {
	...
	ret, err := m.ExecNoCache(query, data.User, data.Stock, data.Number, data.Cost, data.CreatedAt, data.UpdatedAt, data.DeletedAt, data.IsDeleted)
...
func (m *defaultHoldpositionModel) Update(data *Holdposition) error {
	...
	_, err := m.Exec(func(conn sqlx.SqlConn) (result sql.Result, err error) {
		...
		return conn.Exec(query, data.User, data.Stock, data.Number, data.Cost, data.CreatedAt, data.UpdatedAt, data.DeletedAt, data.IsDeleted, data.Id)
	}, holdpositionIdKey)
	return err
}
